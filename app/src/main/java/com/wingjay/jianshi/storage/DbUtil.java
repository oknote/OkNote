package com.wingjay.jianshi.storage;
...
import com.wingjay.jianshi.android.JianShiApplication;
...
public class DbUtil {
    ...
    public static long updateDiary(String title, String content, long diaryId) {
        ...
        contentValues.put(Diary.TITLE, title);
        contentValues.put(Diary.CONTENT, content);
        contentValues.put(Diary.MODIFIED_TIME, FullDateUtil.getTodayDateSeconds());
